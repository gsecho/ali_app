<?php
/**
 * TOP API: qimen.aliexpress.logistics.getonlinelogisticsinfo request
 * 
 * @author auto create
 * @since 1.0, 2018.02.06
 */
class AliexpressLogisticsGetonlinelogisticsinfoRequest
{
	/** 
	...
	{
		return "qimen.aliexpress.logistics.getonlinelogisticsinfo";
	}
