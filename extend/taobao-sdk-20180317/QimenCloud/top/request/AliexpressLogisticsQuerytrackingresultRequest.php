<?php
/**
 * TOP API: qimen.aliexpress.logistics.querytrackingresult request
 * 
 * @author auto create
 * @since 1.0, 2018.02.09
 */
class AliexpressLogisticsQuerytrackingresultRequest
{
	/** 
	 * 卖家登录的login_id
	 **/
	...
	{
		return "qimen.aliexpress.logistics.querytrackingresult";
	}
